...
import cvmIconLight from 'shared-utils/assets/icons/cvm-light.svg?url';
import cvmLogoLight from 'shared-utils/assets/logos/cvm-light.svg?url';
...
const ChainIcon = ({
  ...
  switch (chainName) {
    case 'cvm':
      [iconDark, iconLight] =
        type === 'icon'
          ? [cvmIconLight, cvmIconLight]
          : [cvmLogoLight.src, cvmLogoLight.src];
      break;
    case 'agoric':
      [iconDark, iconLight] =
        type === 'icon'
